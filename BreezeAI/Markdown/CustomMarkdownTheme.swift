...
extension Color {
    fileprivate static let text = Color(.white)
  
    fileprivate static let secondaryText = Color(.white)
    
    fileprivate static let tertiaryText = Color(
    light: Color(rgba: 0x6d70_7dff), dark: Color(rgba: 0x6d70_7dff)
    )
    fileprivate static let background = Color(
    light: Color(rgba: 0x1819_1dff), dark: Color(rgba: 0x1819_1dff)
    )
    fileprivate static let secondaryBackground = Color(
    light: Color(rgba: 0x2526_2aff), dark: Color(rgba: 0x2526_2aff)
    )
    fileprivate static let link = Color(
    light: Color(rgba: 0x4c8e_f8ff), dark: Color(rgba: 0x4c8e_f8ff)
    )
    fileprivate static let border = Color(
    light: Color(rgba: 0x4244_4eff), dark: Color(rgba: 0x4244_4eff)
    )
    fileprivate static let divider = Color(
    light: Color(rgba: 0x3334_38ff), dark: Color(rgba: 0x3334_38ff)
    )
